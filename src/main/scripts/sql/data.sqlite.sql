...
CREATE TABLE IF NOT EXISTS instrument (
   ...
   days INTEGER,
   roll_today INTEGER);
CREATE UNIQUE INDEX instrument_unique on instrument (symbol,provider);
...
CREATE TABLE IF NOT EXISTS instrument_variation (
   ...
   tick DECIMAL(18,8) NOT NULL);
CREATE UNIQUE INDEX iv_unique2 on instrument_variation (original_provider, original_symbol);

--INSERT INTO instrument VALUES(1,'pinnacle','AN','FUT',1000.0,0.01,10.0,'Australian Dollar','CME','HHHMMMUUUZZZ',8,0,2,2,NULL,NULL,NULL,46,66,0);
...
--INSERT INTO instrument VALUES(19,'pinnacle','LB','FUT',110.0,0.1,11.0,'Lumber','CME','FHHKKNNUUXXF',1,0,2,1,NULL,NULL,NULL,NULL,41,59);
--INSERT INTO instrument VALUES(20,'pinnacle','EC','FUT',2500.0,0.0025,6.25,'Eurodollar','CME','HHHMMMUUUZZZ',22,1,3,4,NULL,NULL,NULL,NULL,36,52);
--INSERT INTO instrument VALUES(21,'pinnacle','MD','FUT',100.0,0.1,10.0,'E-mini S&P 400','CME','HHHMMMUUUZZZ',-13,0,3,2,NULL,NULL,NULL,NULL,49,69);
...
CREATE UNIQUE INDEX ie_unique on instrument_exchange (symbol);
